...
public class MillMenu extends AbstractContainerMenu {
    ...
    public MillMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 34, 17));
            this.addSlot(new OutputGUISlot(iItemHandler, 2, 116, 35));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 56, 53));
        });
